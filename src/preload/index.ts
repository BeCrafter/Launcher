...
const api: LauncherApi = {
  ...
  agents: {
    ...
    readDocument: (id) => ipcRenderer.invoke(IPC.agReadDocument, id),
    saveForm: (input) => ipcRenderer.invoke(IPC.agSaveForm, input),
    saveXml: (input) => ipcRenderer.invoke(IPC.agSaveXml, input),
    renameAgent: (input) => ipcRenderer.invoke(IPC.agRename, input),
    remove: (id, expectedRevision) => ipcRenderer.invoke(IPC.agRemove, id, expectedRevision),
    clone: (input) => ipcRenderer.invoke(IPC.agClone, input),
